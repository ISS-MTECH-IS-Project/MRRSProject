...
[![image](https://user-images.githubusercontent.com/97829579/165913978-f423acd9-1509-4c6b-a329-5207675ac6a4.png)](https://www.youtube.com/watch?v=YBcyRB6ct-8)
...
| ------------ | ------------ | ------------ | ------------ |
| Lim Eng Hwee Jason  | A0180557Y  | 1. Team Leader<br/>2. Designing the data preparation module<br/>3. Ideation<br/>4. Architecture and System Design<br/>5. Neomodel layer abstraction and data access layer<br/>6. Filling up data fields related to disease treatments and causes<br/>7. Cleaning up CSV and labelling of diseases and symptoms<br/>8. Front-end UI enhancements and revamp of desired cosmetic (user) behaviours<br/>9. Testing of front and backend integration<br/>10. Test cases write up and test evaluation<br/>| e0284043@u.nus.edu |
| Tan Sio Poh | SXXXX916J  | 1. Ideation<br/>2. Architecture and System Design<br/>3. Exploration and detailed research on Topic Modelling<br/>4. Detailed research on sentence similarity<br/>5. Development of the Core Reasoning Intelligence and Topic Modelling Module<br/>6. Documentation on the Core Reasoning Intelligence<br/>7. Contributed to the video creation covering the Topic Modelling portion | siopoh@gmail.com |
| Teo Wei Ming  |  A0249278M | 1. Contributed to the initial ideation and selection of the idea<br/>2. Established the project proposal<br/>3. Defined the problem statement, business opportunity, solution with the value proposition<br/>4. Project managed the scope and delivery schedule<br/>5. Participated and contributed to the system architecture and module designs<br/>Researched on the pet fishkeeping and market value in Singapore<br/>6. Established the executive summary and conclusion<br/>7. Amalgamated the project report<br/>8. Developed the Conversational Control Module (CCM)<br/>9. Contribution to conceptual and architecture designs of video creation | weimingteo@u.nus.edu |
